...
def createRectMask(width, height, leftPointX, leftPointY, rightPointX, rightPointY):
    img = Image.new('1', (width, height))
    d = ImageDraw.Draw(img)
    d.rectangle((leftPointX, leftPointY, rightPointX, rightPointY), (1))
    img.save("./uimasks/mask.jpg")
    # image = cv.imread("./uimasks/mask.jpg")
    # plt.imshow(image)
    # plt.show()
